# -*- coding: utf-8 -*-
"""data_analysis(hotel_booking).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Xhg4IGkMKIyfkAy-_S3S_C3CraADzWRd
"""
...
plt.figure(figsize=(20,8))
plt.title('Average Daily Rate in City and Resort Hotel', fontsize=30)
# Use resort_hotel.values to access the adr values
plt.plot(resort_hotel.index, resort_hotel.values, label='Resort Hotel')
# Use city_hotel.values to access the adr values
...
# Pass the data to the 'data' argument and specify 'x' and 'y' using column names:
...
# Create a DataFrame for bookings that were not canceled
...
# For not cancelled reservations
...
plt.figure(figsize=(20,6))
plt.title('Average Daily Rate',fontsize=50)
plt.plot(not_cancelled_df_adr['reservation_status_date'], not_cancelled_df_adr['adr'], label='not cancelled')
plt.plot(cancelled_df_adr['reservation_status_date'], cancelled_df_adr['adr'], label='cancelled')
plt.legend()
plt.show()
